...
int main(int argc, char *argv[]){
    ...
    if(server_args_ctor(&args, argc, argv, 1000000))    return EXIT_FAILURE;        // Construct arguments structure from argc/argv
    if(server_threads_init())                           return EXIT_FAILURE;        // Initialize threads
