 ...
 * 
 * Also destructs memory pointed by p;
 * thus you do not need to free p, but you should set it to NULL.
 * 
 ...
 * @param n new value
 */
int atomic_lli_set(atomic_lli_t *p, lli_t n) __attribute__((warn_unused_result));
/**
 ...
 */
int atomic_lli_get(atomic_lli_t *p, lli_t *n) __attribute__((warn_unused_result));
/**
